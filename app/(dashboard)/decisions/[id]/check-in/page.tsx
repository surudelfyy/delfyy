...
export default async function CheckInPage({ params }: PageProps) {
  ...
  const { data: decision, error } = await supabase
    .from('decisions')
    .select(
      'id, question, decision_card, winning_outcome, check_in_outcome, check_in_date',
    )
    .eq('id', params.id)
    .single()
  ...
  return (
    <div className="container max-w-2xl px-4 py-8">
      ...
      <h1 className="mb-8 text-2xl font-bold tracking-tight">Check in</h1>
      ...
      <div className="mb-8 rounded-xl border bg-card p-6">
        ...
        {decision.winning_outcome &&
          decision.winning_outcome !== 'Not provided' && (
